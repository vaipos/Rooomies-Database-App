...
public class ListsMainpage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lists_mainpage2);
        ...
        fstore.collection(userId).orderBy("List", Query.Direction.ASCENDING)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        if (error != null) {
                            Toast.makeText(ListsMainpage2.this, "List Error", Toast.LENGTH_SHORT).show();
                            return;
                        }
